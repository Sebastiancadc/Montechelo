...
<body class="error404 text-center">
    <div class="container-fluid  error-content">
        <div class="">
            <img alt="image-404" src="{{asset("images/errores/error-cartoon.png")}}" class="img-cartoon">
            <h1 class="error-number">404</h1>
            <p class="error-des mb-0">¡Página no encontrada!</p>
            <p class="error-text mb-4 mt-1">Esta página no está disponible</p>

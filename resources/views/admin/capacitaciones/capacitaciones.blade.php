        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">{{__('Capacitaciones')}}</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{__('Capacitaciones')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="card blues">
                                        ...
                                        <div class="card-body awhite">
                                            ...
                                            <a href="{{$item->link}} " type="button" target="_blank"
                                                ...
                                                style="float: right;"><cite>{{__('Acceder')}}</cite>
                                            </a>
                                        </div>
                                    </div>
                                </div>

        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Buzón de sugerencias</h6>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('crearsugerencias')}}">
                        ...
                        <div class="form-group">
                            ...
                            @endif
                            <label class="form-control-label" for="exampleFormControlInput1" name="tipo_sugerencia">Título</label>

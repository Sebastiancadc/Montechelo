                    ...
                    <div class="card"
                        ...
                        <div class="card-body" style="text-align: justify">
                            ...
                            <p class="card-text mt-4" style="text-align: justify;">
                                <font class="vetii">
                                    <font class="vetii">Los colaboradores llevamos semanas trabajando desde casa y es
                                        importante tener en cuenta ciertas pautas básicas para evitar dolores en el
                                        cuello y espalda. Ahí la importancia de realizar pausas activas durante el
                                        teletrabajo. <br>
                                        Por ello en esta entrada te contaremos de los ejercicios que puedes hacer en tu
                                        casa para evitar dolores, preservar una buena postura y mantener una alta
                                        energía para continuar con tus labores. </font>
                                </font>
                            </p>
                        ...
                        <div class="card-group">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text mt-4" style="text-align: justify">
                                        <font class="vetii">
                                            <font class="vetii">A continuación te presentamos una serie de ejercicios
                                                principalmente de elongación
                                                que puedes realizar entre tus periodos de trabajo. Recuerda realizarlos
                                                a
                                                diario, en
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text mt-4" style="text-align: justify">
                                        <font class="vetii">
                                            <font class="vetii">Las pausas activas son breves descansos durante la
                                                jornada
                                                laboral que sirven para recuperar energía, mejorar el desempeño y
                                                eficiencia en
                                                el trabajo, a través de diferentes técnicas y ejercicios que ayudan a
                                                reducir la
                                                fatiga laboral y prevenir el estrés.</font>
                                        </font>
                                    </p>
                                    <a href="#!" class="btn btn-link px-0">
                                        <font class="vetii"></font>

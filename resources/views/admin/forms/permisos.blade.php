                            ...
                            <div id="collapseOne{{$permiso->Id_Rol}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item"><h4 class="colorsito">Chat</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Directorio</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Talento Humano</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Repositorio</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Calendario</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Solicitud</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Buzon de sugerencias</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Plan estrategico</h4>
                                        ...
                                        <li class="list-group-item"><h4 class="colorsito">Novedad</h4>

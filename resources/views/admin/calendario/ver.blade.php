      ...
      <div class="col-lg-7">
        ...
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item"><h3 class="card-title mb-3">Titulo</h3> {{$eventos->name}} </li>
              <li class="list-group-item"><h3 class="card-title mb-3">Fecha inical</h3> {{$eventos->start_time}} </li>
              <li class="list-group-item"><h3 class="card-title mb-3">Fecha final</h3> {{$eventos->end_time}} </li>
            </ul>
            <!-- Card body -->

  ...
  <div class="container-fluid d-flex align-items-center">
    <div class="row">
      <div class="col-lg-7 col-md-10">
            ...
            <form action="{{url('/user/perfil')}}" id="avatarForm"> <input type="file" style="display:none" id="avatarInput"></form>

        <img  src="{{asset("plantilla/img/theme/team-1.jpg")}}"  alt="" id="avatarImage" class="rounded-circle" style="width: 120px; margin-top: 70px">

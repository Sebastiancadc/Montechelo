          ...
          <li class="list-group-item px-0">
            <div class="row align-items-center">
              ...
              <div class="col">
                ...
                <div class="">
                  <div class="progress-bar bg-orange" role="progressbar" aria-valuenow="60" aria-valuemin="0"
          ...
          <li class="list-group-item px-0">
            <div class="row align-items-center">
              ...
              <div class="col">
                <h5>Diseñadores</h5>
                <div class="">
                  <div class="progress-bar bg-teal" aria-valuenow="90" aria-valuemin="0"
          ...
          <li class="list-group-item px-0">
            <div class="row align-items-center">
              ...
              <div class="col">
                    <h5>Java español</h5>
                    <div class="">
                      <div class="progress-bar bg-teal" role="progressbar" aria-valuenow="90" aria-valuemin="0"
                        aria-valuemax="100" style="width: 90%;"></div>
                    </div>
                  </div>
                </div>
                          ...
                          <div class="col-lg-4" style="margin-top: -202px;margin-left: 190px">
                            <div class="form-group">
                                ...
                                <div class='input-group date' id='datetimepicker1'>
                                    <input type='text' class="form-control" name="start_time" value='{{ Auth::user()->cumpleanios}}'>
